...
C     Output file: e1rpex.dat (exact solution)                         *
*                                                                      *
...
*
      OPEN(UNIT = 1,FILE = 'e1rpex.dat',STATUS = 'UNKNOWN')
*
      WRITE(1, *) 'variables = x, Rho, u, P, E'
	WRITE(1, *) 'zone t="line", i=', CELLS,',f=point'
	DO 10 I = 1, CELLS
*
         XPOS = (REAL(I) - 0.5)*DX
...
*
C        Exact solution profiles are written to e1rpex.dat.
*

	   WRITE(1, 20) (XPOS-0.5), DS, US, PS/PSCALE, 
     c	            PS/DS/G8/PSCALE
*
 10   CONTINUE
*
